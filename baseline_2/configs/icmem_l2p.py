...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--dataset', default='Split-ICMem', type=str, help='dataset name')
    subparsers.add_argument('--baseline_file_high', default=None, type=str, help='baseline file name for high memorability')
    subparsers.add_argument('--baseline_file_low', default=None, type=str, help='baseline file name for low memorability')
    subparsers.add_argument('--baseline_mode', default='high', type=str, help='baseline mode for training')
    subparsers.add_argument('--replay_size', default=0, type=int, help='replay buffer size')
    ...
    subparsers.add_argument('--no-pin-mem', action='store_false', dest='pin_mem',
                        help='')
    subparsers.add_argument("--custom_weight_path", type=str, default=None, help="Path to custom weights for the model")
    ...
    subparsers.add_argument('--num_tasks', default=4, type=int, help='number of sequential tasks')
